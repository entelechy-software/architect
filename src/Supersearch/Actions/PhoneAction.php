...
/**
 * Initiate a phone call via `tel:` link.
 *
 * The `$valueResolver` callable receives the record and returns a phone number string.
 */
final class PhoneAction implements SearchAction
{
