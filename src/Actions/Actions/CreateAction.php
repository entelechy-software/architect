...
/**
 * Creates a new record, optionally collecting input from an inline form.
 *
 ...
 * can render the specified FormEngine. Otherwise run() is called directly.
 */
class CreateAction extends Action
{
    ...
    public function run(mixed $record, array $data = []): void
    {
        ...
        // Default: no-op — the form slide-over handles record creation.
    }
}
